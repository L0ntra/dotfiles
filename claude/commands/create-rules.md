---
description: Generate global rules (CLAUDE.md) by analyzing the codebase and extracting patterns.
---

# Create Global Rules

Generate project-specific global rules that give the AI context about:
...
4. Optionally create reference docs
```
